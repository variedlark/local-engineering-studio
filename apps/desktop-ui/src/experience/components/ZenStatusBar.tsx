...
export const ZenStatusBar = memo(function ZenStatusBar({
  ...
  return (
    <div className="pointer-events-auto fixed bottom-0 left-0 right-0 flex h-[var(--les-status-height)] items-center justify-between border-t border-white/10 bg-[var(--les-surface-strong)]/70 px-4 text-[10px] font-mono text-white/50 backdrop-blur-md">
